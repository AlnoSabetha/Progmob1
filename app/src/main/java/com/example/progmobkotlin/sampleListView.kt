...
class sampleListView : AppCompatActivity() {
    var items = arrayOf("lorem", "ipsum", "dolor", "sit", "amet",
        ...
        "vitae", "arcu", "aliquet", "mollis","etiam", "vel",
        "erat", "placerat", "ante","porttitor", "sodales", "pellentesque",
        "augue", "purus")

    lateinit var lvSample : ListView
    lateinit var spSmpleList : Spinner
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        spSmpleList = findViewById(R.id.spSampleListView)
        spSmpleList.adapter = ArrayAdapter(this, android.R.layout.simple_spinner_item, items)
        spSmpleList.onItemSelectedListener = object : AdapterView.OnItemSelectedListener {
